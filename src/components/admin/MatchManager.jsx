...
function MatchManager() {
  ...
  const fetchMatches = async () => {
    try {
      ...
      console.error(
        "Errore nel fetch delle partite:",
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      goalScorers:
        formData.goalScorers?.length > 0 ? formData.goalScorers : undefined,
    };
  ...
  return (
    <div>
      ...
      <form
        ...
        className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2 mt-3 mb-4"
      >
        <div className="col">
          <input
            type="datetime-local"
        ...
        <div className="row align-items-center g-2 mb-1" key={index}>
          <div className="col-9 col-sm-10">
            <select
              ...
              value={scorer.player}
              onChange={(e) =>
                handleScorerChange(index, "player", e.target.value)
              }
            >
              ...
              <tr key={match._id}>
                ...
                <td>
                  <span className="badge bg-info text-dark">
                    {match.stage ? match.stage : "girone"}
                  </span>
                </td>
